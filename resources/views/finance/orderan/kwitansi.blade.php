...
<body>
    ...
    <button id="createPDF">Print</button>
    ...
    <script>
        ...
        let cacheWidth = printArea.width();
        ...
        function createPDFReport() {
            getCanvas().then(function(canvas) {
                ...
                doc.save('dunlood.pdf');
                printArea.width(cacheWidth);
            });
        }

        function getCanvas() {
            printArea.width((a4[0] * 1.33333) - 80).css('max-width', 'none');  
        ...
        function convertHTMLToPDF() {
            ...
            var pdfjs = document.querySelector('#print-area');
