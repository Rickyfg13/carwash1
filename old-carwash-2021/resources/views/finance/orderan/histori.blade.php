            ...
            <div class="card mb-2">
              ...
              <div class="card-body">            
                ...
                <div class="text-center mt-2">                  
                  <a href="{{ url('finance/updateStatus?id='.$item->id.'&permintaan=1') }}" class="btn btn-success btn-sm" style="padding:10px 30px"><i class="fa fa-check"></i> SELESAIKAN</a>
                </div>  
              </div>
              ...
              <div class="card-body">            
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 offset-4">
                        <a target="_blank" href="{{url('finance/print', $item->id)}}" class="btn btn-sm btn-success">Print</a>
                    </div>
                </div>
