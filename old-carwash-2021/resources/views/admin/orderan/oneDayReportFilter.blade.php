...
<div class="container">
  <div class="card mt-5">
    <h3 class="card-header bg-light text-danger">
    ...
    <div class="card-body">
      <form action="{{ url('admin/pendapatan/filter') }}" method="post">
        @csrf
        <div class="form-row">
          <div class="col">Hasil Filter Data Orderan</div>
          @php
            if (isset($tanggal)){
              echo '<div class="col">
                      <input type="date" name="tglmulai" id="tglmulai" class="form-control" value="'. date('d/m/Y', strtotime($tanggal)).'">
                    </div>
                    <div class="col">
              ...
              echo '<div class="col">
                      <input type="date" name="tglmulai" id="tglmulai" class="form-control" value="'. date('d/m/Y', strtotime($tglmulai)).'">
                    </div>
                    <div class="col">
                      <input type="date" name="tglakhir" id="tglakhir" class="form-control" value="'. date('d/m/Y', strtotime($tglakhir)).'">
                    </div>';
            } else {
              echo '<div class="col">
